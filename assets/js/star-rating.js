...
$(function () {    //shorthand for document ready
	...
	$('#training_rating_input, #training_rating_input_readonly, #pgd_rating_input, #pgd_rating_input_readonly').rating({
		  showClear: false,
		  showCaption: false,
		  animate: false
		 });

	$('#training_rating_input').on('rating.change', function() {
		var given_rating = $('#training_rating_input').val();
		var pid = $('#pid').val();
		var pu_id = $('#pu_id').val();
		...
		$.ajax({
			...
			type: "POST",
			url: SURL+"training/submit-training-rating/",
			data: "rating="+given_rating+"&pid="+pid+"&pu_id="+pu_id,
			beforeSend : function(result){
			
			},
			success: function(result){
				
				//$('#rating_container').append('<p class="success">Thank you for rating the product.</p>');
				$("#overlay").removeClass("hidden");
				$("#submit_training_review_frm").removeClass("hidden");
				
				//$("#training_review_link").click(); //Open PGD Links
			}
		});
	});
	
	$('#pgd_rating_input').on('rating.change', function() {
		var given_rating = $('#pgd_rating_input').val();
		var pid = $('#pid').val();
		var pu_id = $('#pu_id').val();
		...
		$.ajax({
			...
			type: "POST",
			url: SURL+"pgd/submit-pgd-rating/",
			data: "rating="+given_rating+"&pid="+pid+"&pu_id="+pu_id,
			beforeSend : function(result){
			...
			success: function(result){
				...
				//$('#rating_container').append('<p class="success">Thank you for rating the product.</p>');
				$("#overlay").removeClass("hidden");
				$("#submit_pgd_review_frm").removeClass("hidden");
				//$("#pgd_review_link").click(); //Open PGD Links
