				...
				<div class="clearfix"></div>
					...
					<script type="application/javascript">
						...
						var oTable = $('#pharmacy_ajax_list').dataTable({
							...
							"bServerSide": true,
							"sServerMethod": "POST",
							"sAjaxSource": "<?php echo base_url()?>avicenna/pharmacy-ajax-list",
							"aoColumnDefs": [{ 'bSortable': false, 'aTargets': [ 0,1,2,3,4, 5 ] }], //set columns sorting. column count from right
							"aaSorting": [],
							"iDisplayLength": 50,
							"bPaginate": true,
