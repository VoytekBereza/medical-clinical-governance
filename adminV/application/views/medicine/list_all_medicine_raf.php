  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_content"> <br />
        ...
        <div class="row">
			<div class="x_title">
			<h2><?php echo filter_string($medicine_details['medicine_name']);?> RAF Listing<small><?php echo filter_string($medicine_details['medicine_name']);?> RAF Listing</small></h2> 
            <div class="nav navbar-right panel_toolbox">
			 <a href="<?php echo SURL?>medicine/add-update-medicine-raf/<?php echo $this->uri->segment(3);?>" class="btn btn-sm btn-success">Add Medicine RAF</a>
		   </div> 
			<div class="clearfix"></div>
			</div>
                
                 <form id="list_medicine_raf_frm" name="list_medicine_raf_frm" data-parsley-validate class="form-horizontal form-label-left form_validate" method="post" enctype="multipart/form-data" action="<?php echo SURL?>medicine/update-medicine-raf-order-process">
               	 <div class="row">
                 	<div class="col-md-4">
                 		<label  data-placement="right"  for="raf_lable" title="Select Raf Labels">Select RAF Label</label>
                 		<select id="raf_lable" name="raf_lable" class="form-control" aria-invalid="false" onchange="javascript:select_raf_lable('<?php echo $this->uri->segment(3);?>',this)">
			...
			<?php if(!empty($list_all_medicine_raf)){ $DataTableId ="examplemedicineraf";} else { $DataTableId = '';}?>
             ...
             <table id="<?php //echo $DataTableId; ?>" class="table table-striped table-bordered table-hover">
				...
				<?php if(!empty($list_all_medicine_raf)){?>
					  
                      <?php foreach($list_all_medicine_raf as $each): ?>
                        ...
                        <tr class="even pointer"> 
                            ...
                            <td class=" ">
                            <a class="btn btn-info btn-xs pull-left" type="button"  href="<?php echo base_url();?>medicine/add-update-medicine-raf/<?php echo $each['medicine_id'];?>/<?php echo $each['id'];?>" title="Edit RAF"><span class="glyphicon glyphicon-edit"></span></a>
                            <a class="btn btn-danger btn-xs" data-target="#confirm-delete-<?php echo $each['id'];?>" data-toggle="modal" title="Delete RAF" data-href="<?php echo base_url();?>medicine/delete-medicine-raf/<?php echo $each['medicine_id'];?>/<?php echo $each['id'];?>" href="#">X</a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a class="btn btn-danger btn-ok" href="<?php echo base_url();?>medicine/delete-medicine-raf/<?php echo $each['medicine_id'];?>/<?php echo $each['id'];?>">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
