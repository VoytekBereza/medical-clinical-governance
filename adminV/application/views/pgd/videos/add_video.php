<div class="row">
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>Add <?php echo filter_string($pgd_details['pgd_name']);?> Video: <small><?php echo ucfirst($form_action); ?> <?php echo filter_string($pgd_details['pgd_name']);?> video</small></h2>
			...
			<div class="x_content">
				...
				<?php }//if($this->session->flashdata('ok_message'))?>
				<form data-toggle="validator" role="form" class="form-horizontal form-label-left" action="<?php echo base_url(); ?>pgd/add-update-video" method="post" id="add_update_video_form" name="add_update_video_form">
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <!--<div class="form-group">
                             ...
                             <div class="form-group col-md-12 pull-left" style="padding-left:0px;"> 
                            	...
                            	<label class="radio-inline">
                              	<input type="radio" name="default_type" <?php if($video['default_type']=="" || $video['default_type']=="1"){?>checked="checked"<?php }?> value="1">Prezi</label>
                                
                                <label class="radio-inline"></label>
                              	<label class="radio-inline"> <input type="radio"  name="default_type" <?php if($video['default_type']=="0"){?>checked="checked"<?php }?> value="0">Youtube</label>
