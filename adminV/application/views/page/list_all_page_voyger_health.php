  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_content"> <br />
        ...
        <div class="row">
			<div class="x_title">
			<h2>Voyger Health  CMS <small>List Voyger Health CMS Pages</small></h2>
			<div class="nav navbar-right panel_toolbox">
						<a href="<?php echo SURL?>page/add-new-page-voyger-health" class="btn btn-sm btn-success">Add New Page Voyger Health </a>
					</div> 
				...
				<?php if(!empty($list_page_voyger_health)){ ?>
					<?php foreach($list_page_voyger_health as $each):  ?>
						<tr class="even pointer"> 
							...
							<td class=" last">
							<a href="<?php echo base_url(); ?>page/add-new-page-voyger-health/<?php echo $each['id']; ?>" title="Edit" class="btn btn-xs btn-success"> <span class="glyphicon glyphicon-edit"></span> </a> 
