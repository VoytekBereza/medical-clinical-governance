  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_content"> <br />
        ...
        <div class="row">
			<div class="x_title">
			<h2>CMS <small>List CMS Pages</small></h2>
			<div class="nav navbar-right panel_toolbox">
				<a href="<?php echo SURL?>page/add-new-page" class="btn btn-sm btn-success">Add New Page</a>
			</div> 
			<div class="clearfix"></div>
			</div>
             <?php if(!empty($list_page)){ $DataTableId ="exampleCMS";} else { $DataTableId = '';}?>
			<table id="<?php echo $DataTableId; ?>" class="display nowrap dataTable dtr-inline" cellspacing="0" width="100%" role="grid" aria-describedby="example_info" style="width: 100%;">
				...
				<?php if(!empty($list_page)){ ?>
					<?php foreach($list_page as $each):  ?>
						<tr class="even pointer"> 
                            <td class=" "><?php echo filter_string($each['page_title']); ?></td>
							...
							<td class=" last">
							<a href="<?php echo base_url(); ?>page/add-new-page/<?php echo $each['id']; ?>" title="Edit" class="btn btn-xs btn-success"> <span class="glyphicon glyphicon-edit"></span> </a> 
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<a href="<?php echo base_url(); ?>page/delete-page/<?php echo $each['id']; ?>" class="btn btn-danger btn-ok">Delete</a>
										</div>
									</div>
								</div>
							</div>
