    ...
    <div class="x_panel">
      <div class="x_content"> <br />
        ...
        <?php if($get_page_details_voyger_health['id']==""){?>
			<h2>Add New Page Voyager Health <small>Add New Page Voyager Health</small></h2>
			 <?php } else {?>
             <h2>Update Page Voyager Health  <small>Update Page Voyager Health </small></h2>
             <?php }?>
			<div class="clearfix"></div>
			</div>
        <form data-toggle="validator" role="form"   id="add_new_page_frm" name="add_new_page_frm" data-parsley-validate class="form-horizontal form-label-left form_validate" method="post" enctype="multipart/form-data" action="<?php echo SURL?>page/add-new-page-voyager-health-process">
          ...
          <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-11">
              ...
              <?php }//end if($get_page_details_voyger_health['id'])?>
               <input type="hidden" name="cms_type" id="cms_type" value="1" />
            </div>
          </div>
        </form>
      </div>
