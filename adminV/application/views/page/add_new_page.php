  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_content"> <br />
        ...
        <div class="x_title">
        <?php if($get_page_details['id']==""){?>
			<h2>Add New Page <small>Add New Page</small></h2>
			 <?php } else {?>
             <h2>Update Page <small>Update Page</small></h2>
             <?php }?>
			<div class="clearfix"></div>
			</div>
        <form data-toggle="validator" role="form"   id="add_new_page_frm" name="add_new_page_frm" data-parsley-validate class="form-horizontal form-label-left form_validate" method="post" enctype="multipart/form-data" action="<?php echo SURL?>page/add-new-page-process">
            ...
            <div id="myTabContent" class="tab-content">
              <div role="tabpanel" class="tab-pane fade <?php echo $cms_class_div?>" id="cms_tab" aria-labelledby="cms-tab">
                <div class="form-group has-feedback">
                  ...
                  <div class="col-md-12 col-sm-6 col-xs-12">
                    <input type="text" id="page_title" name="page_title" required="required" class="form-control" value="<?php echo filter_string($get_page_details['page_title'])?>">
                ...
                <div class="form-group">
                  ...
                  <textarea class="ckeditor editor1" id="page_description" name="page_description" rows="14"><?php echo filter_string($get_page_details['page_description'])?></textarea>
                </div>
                <div class="form-group">
              ...
              <div role="tabpanel" class="tab-pane fade <?php echo $seo_class_div?>" id="seo_tab" aria-labelledby="seo-tab">
                <div class="form-group">
                  ...
                  <div class="col-md-12 col-sm-6 col-xs-12">
                    <input type="text" id="meta_title" name="meta_title"  class="form-control col-md-7 col-xs-12" value="<?php echo  filter_string($get_page_details['meta_title'])?>">
                  </div>
                </div>
                <div class="form-group">
                  <label for="middle-name">Meta Keywords:</label>
                  <div class="col-md-12 col-sm-6 col-xs-12">
                    <textarea class="form-control" rows="3" placeholder="Meta Keywords" name="meta_keywords" id="meta_keywords"><?php echo filter_string($get_page_details['meta_keywords'])?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label for="middle-name">Meta Description:</label>
                  <div class="col-md-12 col-sm-6 col-xs-12">
                    <textarea class="form-control" rows="3" placeholder="Meta Description" name="meta_description" id="meta_description"><?php echo filter_string($get_page_details['meta_description'])?></textarea>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-11">
              ...
              <?php }//end if($get_page_details['id'])?>
              <input type="hidden" name="cms_type" id="cms_type" value="0" />
            </div>
          </div>
        </form>
      </div>
