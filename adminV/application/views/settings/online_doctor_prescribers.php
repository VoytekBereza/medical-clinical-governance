  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_content"> <br />
        ...
        <div class="row">
			<div class="x_title">
			<h2>Online Doctor Prescribers <small>Online Doctor Prescribers List</small></h2> 
			<div class="clearfix"></div>
			</div>
            <div class="nav navbar-right panel_toolbox">
			 <a href="<?php echo SURL?>settings/add-edit-online-prescribers" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Add New</a>
		   </div> 
            
             <?php if(!empty($prescriber_list)){ $DataTableId ="example-old-user";} else { $DataTableId = '';}?>
            <table id="<?php echo $DataTableId;?>" class="display nowrap dataTable dtr-inline table-striped" cellspacing="0" width="100%" role="grid" aria-describedby="example_info" style="width: 100%;">
				...
				<?php 
					if(!empty($prescriber_list)){

					  	foreach($prescriber_list as $each){ 
				?>
                        ...
                        <tr class="even pointer">
                            ...
                            <td width="20%"><?php echo filter_string($each['contact_no']);?></td>
                            <td width="20%"><?php echo filter_string($each['reg_type']);?></td>
                            <td width="20%"><?php echo filter_string($each['email_address']);?></td>
                            <td width="10%"><?php echo ($each['status'] == '0') ? 'Inactive' : 'Active'; ?></td>
                            <td width="10%">
                            <a class="btn btn-info btn-xs pull-left" type="button" href="<?php echo base_url();?>settings/add-edit-online-prescribers/<?php echo $each['id'];?>"><span class="glyphicon glyphicon-edit"></span></a>
						   </td>
                        </tr>
