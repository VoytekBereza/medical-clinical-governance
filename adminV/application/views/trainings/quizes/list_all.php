      ...
      <div class="x_content"> <br />
       <div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						<h2><?php echo filter_string($training_detail['course_name']);?> Exam  <small> <?php echo filter_string($training_detail['course_name']);?> Exam  listing</small></h2>
						<!--<div class="nav navbar-right panel_toolbox">
							<a href="<?php echo base_url(); ?>pgd/rechas/<?php echo $training_id; ?>" class="btn btn-sm btn-success">Add New</a>
						</div> -->
					...
					<div class="x_content">
						...
						<input type="hidden" name="full_path" id="full_path" value="<?php echo base_url(); ?>trainings/quiz_by_id/" />
					</div>
				</div>
			</div>
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<?php }//if($this->session->flashdata('ok_message'))?>
						<p  class="action_name">Please add minimum <?php echo $training_detail['no_of_quizes']; ?> questions.</p>
						<form data-toggle="validator" role="form" method="post" action="<?php echo base_url(); ?>trainings/add_update_quiz/<?php echo $training_id; ?>">
