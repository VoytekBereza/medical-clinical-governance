...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="row">
        <div class="x_title">
          <h2><?php echo filter_string($get_training_details['course_name']); ?> Documents</h2>
          
          <!--<div class="nav navbar-right panel_toolbox">
					<a href="<?php echo base_url(); ?>trainings/add_edit_document/<?php echo $course_id; ?>" class="btn btn-sm btn-success">Add New</a>
				</div>-->
          ...
          <?php 
                ...
                ?>
                              <li>
                                ...
                                <a href="#" style="font-weight:bold"> <?php echo filter_string($split_category_name[1]);?></a>
                                
                                <span> 
                                  
                                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                  <a href="<?php echo SURL?>trainings/edit-document-category/<?php echo $get_training_details['id'];?>/<?php echo filter_string($split_category_name[0]);?>" class="btn btn-xxs btn-success fancybox_view_document fancybox.ajax">
                                    <i class="fa fa-pencil"></i>
                                  </a>

                                  <a class="btn btn-xxs btn-danger dialogue_window white_link" data-toggle="modal" title="Delete Document" href="#confirm_delete_category_<?php echo filter_string($split_category_name[0])?>"><i class="fa fa-times"></i></a>
                                  ...
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                      	<p style="font-weight: normal;">Are you sure you want to delete "<?php echo filter_string($split_category_name[1]); ?>" category? </p>
                                      </div>
                                      <div class="modal-footer">
                                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                        <a href="<?php echo SURL ?>trainings/delete-document-category/<?php echo $get_training_details['id'];?>/<?php echo filter_string($split_category_name[0])?>" class="btn btn-danger btn-ok">Delete</a> </div>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <ul class="list-unstyled">
                                  ...
                                  <?php			
                                        ...
                                        ?>
                                              <li style="font-weight:normal"> <?php echo filter_string($nodes_arr[$i]['document_title'])?>

                                              	&nbsp; &nbsp; &nbsp;
                                                <a href="<?php echo SURL?>trainings/edit-document/<?php echo $get_training_details['id'];?>/<?php echo filter_string($split_category_name[0]);?>/<?php echo filter_string($nodes_arr[$i]['id'])?>" class="fancybox_view_document fancybox.ajax">
                                                ...
                                                <div class="modal fade" id="confirm_delete_document<?php echo filter_string($nodes_arr[$i]['id'])?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                  <div class="modal-dialog">
                                                    <div class="modal-content">
                                                      <div class="modal-header"> <h4> Confirmation! </h4> </div>
                                                      <div class="modal-body"> Are you sure you want to delete "<?php echo filter_string($nodes_arr[$i]['document_title']); ?>" file? </div>
                                                      <div class="modal-footer">
                                                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                                        <a href="<?php echo SURL ?>trainings/delete-document/<?php echo $get_training_details['id'];?>/<?php echo $nodes_arr[$i]['id']?>" class="btn btn-danger btn-ok">Delete</a> </div>
                                                    </div>
                                                  </div>
                                                </div>
                                              </li>
...
<?php
                                  ...
                                  <li style="font-weight:normal">
                                    ...
                                    <a href="<?php echo SURL?>trainings/edit-document/<?php echo $get_training_details['id'];?>/<?php echo filter_string($split_category_name[0]);?>" class="fancybox_view_document fancybox.ajax" style="color: #26B99A;">
...
?>
          ...
          <li style="font-weight:normal">
          	...
          	&nbsp; &nbsp; &nbsp;
          	<a href="<?php echo SURL?>trainings/edit-document/<?php echo $get_training_details['id'];?>/<?php echo filter_string($split_category_name[0]);?>/<?php echo filter_string($categories_list['None'][$i]['id'])?>" class="fancybox_view_document fancybox.ajax">

            	<button class="btn btn-xxs btn-success" type="button" title="Edit"><i class="fa fa-pencil"></i></button>

            </a>

            <a class="btn btn-xxs btn-danger dialogue_window white_link" data-toggle="modal" title="Delete Document" href="#confirm_delete_document<?php echo filter_string($categories_list['None'][$i]['id'])?>">
          ...
          <div class="modal fade" id="confirm_delete_document<?php echo filter_string($categories_list['None'][$i]['id'])?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header"> <h4> Confirmation! </h4> </div>
                <div class="modal-body"> Are you sure you want to delete "<?php echo filter_string($categories_list['None'][$i]['document_title'])?>" file? </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                  <a href="<?php echo SURL ?>trainings/delete-document/<?php echo $get_training_details['id'];?>/<?php echo $categories_list['None'][$i]['id']?>" class="btn btn-danger btn-ok">Delete</a> </div>
              </div>
            </div>
          </div>
<?php
...
?>
          <?php }else{
                ?>
          <p>
            <div role="alert" class="">No File Available!</div>
          </p>
          ...
          <li style="font-weight:normal">
          	...
          	<a href="javascript:;" data-toggle="modal" data-target="#add_new_folder_model" > <strong style="color: #26B99A;"> <p><strong> + Add New Folder</strong></p> </strong> </a>
...
<div id="add_new_none_file_model" class="modal fade" role="dialog">
  ...
  <form   class="form-horizontal form-label-left form_validate2" action="<?php echo base_url(); ?>trainings/add-update-document" method="post" id="add_update_document_form" name="add_update_document_form">
      ...
      <div class="modal-content">
        ...
        <div class="">
          ...
          <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12 form-group validate_msg modal-body">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 form-group validate_msg">
            <label for="middle-name" data-toggle="tooltip" data-placement="right"  title="Add document title"> Document Title* <i class="fa fa-info-circle"></i> </label>
            </label>
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 form-group validate_msg">
            <label for="middle-name"  data-toggle="tooltip" data-placement="right"  title="Add document url"> Document Url* <i class="fa fa-info-circle"></i> </label>
            </label>
          ...
          <!-- Input Hidden Field -->
          <input type="hidden" name="course_id" value="<?php echo $get_training_details['id']; ?>" />
