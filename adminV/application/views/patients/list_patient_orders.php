      ...
      <div class="x_content"> <br />
        ...
        <div class="row">
			...
			<div class="clearfix"></div>
              ...
              <?php if(!empty($list_patient_orders)){ $DataTableId ="orderhistory";} else { $DataTableId = '';}?>
               ...
               <table id="<?php echo $DataTableId; ?>" class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(!empty($list_patient_orders)){
												
												foreach($list_patient_orders as $each) {	
									?>
                                                <tr class="newRow">
                                                    ...
                                                    <td> 
                                                    <a href="<?php echo SURL;?>patient/list-patient-orders_details/<?php echo $each['patient_id'];?>/<?php echo $each['id'];?>" 
