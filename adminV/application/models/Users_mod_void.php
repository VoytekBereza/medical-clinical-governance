			...
			foreach($select as $col)
            {
				...
				if($col == 'admin_verify_status'){
					...
					if(strlen($index_key) > 0){
						...
						//print_this($th_data['expiry_date']);
					...
					if($F18 && $F18 == 1){
						...
						$arr_data .= '<button class="btn btn-xs btn-success" type="button" onClick="assign_pgd_admin(\''.$user_id.'\', \'28\', \'PGD\', \'unassign\', \'Seasonal 2018\',\''.$user_full_name.'\')" > F18 </button>';	
					 
					} else {
					 
						$arr_data .= '<button class="btn btn-xs btn-danger" type="button" onClick="assign_pgd_admin(\''.$user_id.'\', \'28\', \'PGD\', \'assign\', \'Seasonal 2018\',\''.$user_full_name.'\')" > F18 </button>';	
