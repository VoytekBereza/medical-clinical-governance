...
class Pgd_mod extends CI_Model {
	...
	public function add_update_rechas($post, $pgd_id, $rechas_id=''){
		...
		if($rechas_id != ''){ // Update
			...
			$update_data = array(
				...
				'rechas_description' => $rechas_description,
				'status' => $status,
	...
	public function get_all_unauthenticated_pgds2(){
		...
		$this->db->select('user_order_details.*, user_orders.purchase_date,usertype.user_type, users.first_name, users.last_name,users.email_address, users.mobile_no, 
