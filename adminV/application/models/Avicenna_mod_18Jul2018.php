			...
			foreach($select as $col)
            {
				...
				if($col == 'first_name'){
					...
					*/
					...
					if($pT && $pT == 1){
						$arr_data .= '<button class="btn btn-xs btn-success" type="button" onClick="assign_pgd_admin(\''.$user_id.'\', \'10\', \'PGD\', \'unassign\', \'Travel Core 3.0\',\''.$user_full_name.'\')" > T17 </button>';
						
					} else {
						$arr_data .= '<button class="btn btn-xs btn-danger"  type="button" onClick="assign_pgd_admin(\''.$user_id.'\', \'10\', \'PGD\', \'assign\', \'Travel Core 3.0\',\''.$user_full_name.'\')" > T17 </button>';	
						
					}//end if($pT && $pT == 1)
					
					if($pT18 && $pT18 == 1){
						$arr_data .= '<button class="btn btn-xs btn-success" type="button" onClick="assign_pgd_admin(\''.$user_id.'\', \'31\', \'PGD\', \'unassign\', \'Travel Core 4.0\',\''.$user_full_name.'\')" > T18 </button>';
						
					} else {
						$arr_data .= '<button class="btn btn-xs btn-danger"  type="button" onClick="assign_pgd_admin(\''.$user_id.'\', \'31\', \'PGD\', \'assign\', \'Travel Core 4.0\',\''.$user_full_name.'\')" > T18 </button>';	
