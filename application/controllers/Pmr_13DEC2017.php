...
class Pmr extends MY_Organization_Controller {
	...
	public function patient_dashboard($patient_id, $order_id='', $vaccine_type=''){
		...
		if($order_id != ''){
			...
			$order_details = $this->pmr->get_patient_order_item_details($order_id);
		...
		$data['patient_history'] = $this->pmr->get_patient_grouped_history($patient_id, 'C');
	...
	public function patient_medicine_history($patient_id, $medicine_id, $order_status = '', $is_online=''){
		...
		$data['patient_history'] = $this->pmr->get_patient_history($patient_id, $order_status, $medicine_id);
