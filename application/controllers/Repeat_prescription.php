...
class Repeat_prescription extends MY_Organization_Controller {
   ...
   // Start => function index()
	public function index(){
		...
		$data['repeat_prescription_list'] = $this->repeat_prescription->get_repeat_prescription_listing($this->session->pharmacy_surgery_id);
        ...
        // Load view
        $this->stencil->paint('repeat_prescription/repeat_prescription_listing',$data);
