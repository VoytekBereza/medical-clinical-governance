...
if($pgd_access_allowed['is_quiz_passed'] == 0){
	...
	if($total_hours_passed >= $pgd_details_arr['pgd_reattempt_quiz_hours']){
		...
		if($pgd_access_allowed['no_of_attempts'] >= $pgd_details_arr['pgd_number_of_attempts_allowed']){
            ...
            <div id="quiz_container">
                  <form action="#" method="post" enctype="multipart/form-data" name="quiz_frm" id="quiz_frm">
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <p class="page-header"><strong><!--<span class="text-primary"> Question:</span>--> <?php echo filter_string($get_quiz_list['quiz_question']['question'])?></strong></p>
                        <p>
...
?>
		<div class="alert alert-danger alert-dismissable"><h3>You cannot reattempt your quiz before <?php echo $pgd_details_arr['pgd_reattempt_quiz_hours']?> Hours. Please check back later.</h3></div>
<?php	
