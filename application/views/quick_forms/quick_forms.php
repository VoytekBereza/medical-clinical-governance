<div class="row">
	<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="jumbotron">
			...
			<!-- Description -->
			<?php echo ($page_data['page_description'] != '') ? $page_data['page_description'] : '' ; ?>
		...
		<div class="row">
			<?php 
				if(count($quick_forms_arr) > 0){ 
				
					$j = 1;
					foreach($quick_forms_arr as $category_name =>$each){
			?>
                        <div class="col-md-4"> 
            ...
            <?php		
					...
					}//end foreach($quick_forms_arr as $category_name =>$each)
					
				}//end if(count($quick_forms_arr) > 0)
			?>
		</div>
