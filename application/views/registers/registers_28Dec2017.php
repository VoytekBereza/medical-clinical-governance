                    ...
                    <div class="col-md-6"> 
						...
						?>
                                ...
                                <div class="col-md-12 text-right">
                                    <a class="btn btn-sm btn-success fancybox_view fancybox.ajax" href="<?php echo base_url(); ?>registers/add-edit-supplier/1" style="color:#FFF">Add Supplier</a>
                                
                                    <a class="btn btn-sm btn-warning fancybox_view fancybox.ajax" href="<?php echo base_url(); ?>registers/add-edit-prescriber/1" style="color:#FFF">Add Prescriber</a>
                                    <a class="btn btn-sm btn-danger fancybox_view fancybox.ajax" href="<?php echo base_url(); ?>registers/add-edit-patient/1" style="color:#FFF">Add Patient</a>
