      ...
      <div class="col-sm-6 col-md-12 col-lg-12">
        ...
        <div class="row" style="margin:0">
          <div class="pull-right">
            ...
            <input type="hidden" id="drug_id" name="drug_id" value="<?php echo $drug_id_select_box;?>">
            <input type="hidden" id="stock_received_supplied" name="stock_received_supplied" class="stock_check" value="SS">
