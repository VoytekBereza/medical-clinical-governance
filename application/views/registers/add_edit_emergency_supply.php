    ...
    <div class="nav nav-bar col-sm-12 col-md-12 col-lg-12">
      <div class="row">
        <div class="col-sm-6 col-md-6 col-lg-6">
          <h4>Add emergency supply entry:</h4>
        </div>
      </div>
      ...
      <div class="row">
        <form action="<?php echo SURL?>registers/add-edit-emergency-supply-process" method="post" name="add_emergecy_frm" id="add_emergecy_frm" >
          <div class="col-sm-6 col-md-12 col-lg-12">
              ...
              <div class="form-group has-feedback">
                                        ...
                                        if($('#patient_id').val() == ''){
                                          ...
                                          if($('.help-block')){
                                            $.each( $('.help-block'), function(k, error_el){
                                              ...
                                              $('#add_emergecy_frm').attr('onsubmit','return false;');
    
                                        } else {
                                        
                                             // Allow form submission
                                             $('#add_emergecy_frm').attr('onsubmit','return true;');
                ...
                <div class="form-group has-feedback">
                 ...
                 <div class="form-group has-feedback">
                  <label>Cost to patient(&pound;)</label>
                  <input type="number" min="0" class="form-control" name="cost_patient" id="cost_patient" value="" />
                  <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                  <div class="help-block with-errors"></div>
                </div>
                
                <div class="form-group has-feedback">
                  <label>Reason for supply<span class="required">*</span></label>
                  <textarea class="form-control"  name="reason_supply" id="reason_supply" value="" rows="4" required="required"/>
                  <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                  <div class="help-block with-errors"></div>
                </div>
            ...
            <div class="pull-right">
            	<button type="submit" class="btn btn-sm btn-success btn-block"  name="add_update_btn"> Add new entry</button>
                 <input type="hidden" id="tab_id_emergency" name="tab_id" value="<?php echo $tab_id;?>">
...
$(document).ready(function(){
		...
		if($('#add_emergecy_frm').html()){

		    $('#add_emergecy_frm').formValidation({
		        framework: 'bootstrap',
		        icon: {
						...
						success: function(response){
							...
							if(response != 'empty'){
								...
								if($(_this).attr("kod-popup") != 'true'){
									html += '<li class="list-group-item text-primary suggession_item_li" style="padding-top:5px;" ><strong style="cursor:pointer;"><a href="'+SURL+'registers/add-edit-patient/5" class="fancybox_view fancybox.ajax"> Add new patient </a></strong></li>';
								} // if($(_this).attr("kod-popup") != 'true')
								...
								var html = '<ul id="patient-list" class="list-group" style="z-index: 999; position: absolute; width: 97.4%; overflow-y: auto; min-height:50px; max-height:910px;">';
									...
									if($(_this).attr("kod-popup") != 'true'){
									   	html += '<a href="'+SURL+'registers/add-edit-patient/5" class="fancybox_view fancybox.ajax"> <li class="list-group-item text-primary '+ cls +'" style="padding-top:5px;" ><strong style="cursor:pointer;"> Add new patient </strong></li> </a>';
									} // if($(_this).attr("kod-popup") != 'true')
...
$('.medicine_name').keydown(function(e){
	...
	var my_id = $(_this).attr("id");
	var el_id = $(_this).attr("element");
	var tab_id = $('#tab_id_emergency').val();
					...
					$.ajax({
						...
						success: function(response){
							...
							if(response != 'empty'){
								...
								if($(_this).attr("kod-popup") != 'true'){
									html += '<li class="list-group-item text-primary suggession_item_li" style="padding-top:5px;" ><strong style="cursor:pointer;"><a href="'+SURL+'registers/add-edit-registers/5" class="fancybox_view fancybox.ajax"> Add new medicine </a></strong></li>';
								} // if($(_this).attr("kod-popup") != 'true')
								...
								var html = '<ul id="medicine-list" class="list-group" style="z-index: 999; position: absolute; width: 97.4%; overflow-y: auto; min-height:50px; max-height:910px;">';
									...
									if($(_this).attr("kod-popup") != 'true'){
									   	html += '<a href="'+SURL+'registers/add-edit-registers/5" class="fancybox_view fancybox.ajax"> <li class="list-group-item text-primary '+ cls +'" style="padding-top:5px;" ><strong style="cursor:pointer;"> Add new medicine </strong></li> </a>';
									} // if($(_this).attr("kod-popup") != 'true')
