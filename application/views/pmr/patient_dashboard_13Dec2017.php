					...
					<form id="prescription-preview-form" method="post">
						...
						<div class="row" id="preview-btn-div">
							<div class="col-sm-12 col-md-12 col-lg-12">
								...
								<a class="btn btn-sm btn-success pull-right preview hidden" data-fancybox-type="ajax" href="<?php echo base_url(); ?>pmr/preview-current-transaction" id="preview">Preview</a>
							</div>
						</div>
                            ...
                            <div class="col-md-12">
                                ...
                                <table id="<?php echo $DataTableId; ?>" class="table table-striped table-hover table-bordered" width="100%" cellspacing="0">
                                    ...
                                    ?>
                                                <tr>
                                                    <td>
                                                        <a class="medicine-details-popup" onClick="" data-fancybox-type="ajax" href="<?php echo base_url(); ?>pmr/patient-medicine-history/<?php echo $each['patient_id'];?>/<?php echo $each['medicine_id'];?>/C<?php echo ($is_online && $is_online == 1) ? '/1' : '' ; ?>" id="preview"> <?php echo $each['medicine_name']; ?> </a>
                                                    </td>
