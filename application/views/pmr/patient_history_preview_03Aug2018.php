...
<div id="preview-div">
  ...
  <tbody>
    <tr>
      ...
      <td style="padding:10px"><br />
        <br />
        <p style="color:#3c763d"><strong><?php echo filter_name($prescriber_full_name); ?></strong></p>
        <p><strong><?php echo filter_string($registration_type); ?> Number:</strong> <?php echo filter_string($registration_number); ?><br />
        </p>
      </td>
          ...
          <tbody>
            <tr>
              <td align="center">
                ...
                <?php echo filter_string($organization_details['address']).', '.filter_string($organization_details['postcode'])?>
              </td>
            </tr>
          </tbody>
        </table></td>
             ...
             <tr>
              ...
              <td  style="padding:10px">
                ...
                <p>
                    ...
                    <strong>Email address:</strong> <?php echo filter_string($prescriber_email_address); ?><br />
                    <?php echo ($order_details['default_prescriber']) ? filter_string($prescriber_organization['address']).', '.filter_string($prescriber_organization['postcode']) : filter_string($order_details['p_organization_address']); ?>
                 </p>
