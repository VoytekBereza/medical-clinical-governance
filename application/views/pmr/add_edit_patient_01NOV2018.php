				...
				<p> </p> 
                 <div class="row">
                  ...
                  <div class="row">
                      ...
                      <div class="radio">
                        <label>
                          <input type="checkbox" name="taken_patient_cosent" value="1" />
                         Verbal consent has been taken from the patient and they have had the chance to read our terms and conditions.
                        </label>
                      </div>  
                    </div>     
                  <div class="row">
