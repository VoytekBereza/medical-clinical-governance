        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <?php /*?><li><a href="<?php echo SURL?>services">Services</a></li><?php */?>
                    
                     <li class="dropdown"><a href="javascript:;">Services <b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="<?php echo SURL?>ipreg">IP Register</a></li>
							<li><a href="<?php echo SURL?>travel-core-2">Travel Core</a></li>
							<li><a href="<?php echo SURL?>online-prescribing">Online Prescribing</a></li>
							<li><a href="<?php echo SURL?>digital-back-office">Digital Back Office</a></li>
							<li><a href="<?php echo SURL?>pages/flu-vaccination-training-pharmacists">Flu Training</a></li>
						</ul>
               		</li>
					...
					?>
                        ...
                        <li><a href="<?php echo SURL?>login" class="login-btn"><span class="btn-signin">Login</span></a></li>
