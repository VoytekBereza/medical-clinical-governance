...
<?php
		...
		?>
                	<a onClick="javascript:setCookie(this, 'menu_item_number', 'Website', 1); return false;" href="<?php echo SURL?>organization/website" class="list-group-item <?php echo ($_COOKIE['menu_item_number'] && $_COOKIE['menu_item_number'] == 'Website') ? 'kod-menu-bg' : '' ; ?>"><i class="fa fa-share"></i> Website</a>
