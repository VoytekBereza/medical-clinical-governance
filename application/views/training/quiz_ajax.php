...
?>
      ...
      <div class="">
        ...
        <p>
          If you have any issues please do not hesitate to Contact Us or email us at <a href="<?php echo SURL; ?>contactus"> Contact Us</a>.
        </p>
...
?>
      <!--
			<div class="alert alert-danger alert-dismissable"><h3>You have acheived <u>< ?php echo filter_price($evaluate_quiz['quiz_percentage'])?>%</u> marks and unfortunately failed your assesment test, please try again after < ?php echo $training_details_arr['training_reattempt_quiz_hours'] ?> Hours.</h3></div>
      -->
      ...
      <div class="">
        ...
        <p>
          To pass and have your Training authenticated you need to pass the MCQ questions with a minimum of <?php echo $training_details_arr['training_pass_percentage'].'%'; ?> within <?php echo $training_details_arr['training_number_of_attempts_allowed']; ?> tries. You may retry this quiz after <?php echo $training_details_arr['training_reattempt_quiz_hours']; ?>.
        </p>
        <p>
        ...
        <p>
          If you have further issues please do not hesitate to contact our admin team at <a href="mailto:info@hubnet.io"> info@hubnet.io</a>
        </p>
