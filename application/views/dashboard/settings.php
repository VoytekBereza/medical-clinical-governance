            ...
            <div class="form-group has-feedback">
              ...
              <select name="user_country" id="user_country" class="form-control" required="required">
                ...
                <?php
                    ...
                    ?>
                <option value="<?php echo $country_arr['id']?>"  <?php if($country_arr['id'] == $get_user_profile['user_country']){?> selected="selected"<?php }?>><?php echo $country_arr['country_name']?></option>
                <?php			
        ...
        <div class="col-md-12">
          <form  data-toggle="validator" role="form" action="<?php echo SURL?>dashboard/settings-process"  id="pass_frm" name="pass_frm" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group has-feedback">
              ...
              <input type="password" required="required" class="form-control input-sm" value="" id="new_password" name="new_password" placeholder="New Password" data-error="Password must be between 8 to 30 characters with at least one UPPERCASE, one lowercase and one digit." pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])[A-Za-z0-9!@#$%^&*()]{8,30}$" >
              <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
     		  <div class="help-block with-errors"></div>
            ...
            <div class="form-group has-feedback">
              ...
              <input type="password" required="" class="form-control input-sm" value="" id="confirm_password" name="confirm_password" placeholder="Confirm New Password" data-error="Password must be between 8 to 30 characters with at least one UPPERCASE, one lowercase and one digit or the password you have entered does not match our records." data-match="#new_password" pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])[A-Za-z0-9!@#$%^&*()]{8,30}$"  maxlength="30">
              <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
     		  <div class="help-block with-errors"></div>
            </div>
