<div class="col-xs-12">
  <!-- PAGE CONTENT BEGINS -->  
  <h4 class="blue">Add Acknowledge</h4> 
  <hr /> 
   <br />       
  ...
  <form  data-toggle="validator" role="form" id="acknowledge_frm" name="acknowledge_frm" method="post" action="<?php echo SURL?>complaints/add-complaint-process" autocomplete="off">
                      
  <div class="row">
    <div class="col-md-12" style="padding-left:0px;"> <br />
      <div class="form-group has-feedback">
        <label for="friend_email_address" class="col-md-2"><strong>Acknowledge<span class="required">*</span></strong></label>
         <div class="col-md-10">
        <textarea class="form-control" rows="5" id="acknowledge" name="acknowledge" placeholder="Type Acknowledge"></textarea>
        </div>
 ...
 $(document).ready(function() {
    $('#acknowledge_frm').formValidation({
        framework: 'bootstrap',
        icon: {
