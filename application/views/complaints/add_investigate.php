<div class="col-xs-12">
  <!-- PAGE CONTENT BEGINS -->  
  <h4 class="blue">Add Investigate</h4> 
  <hr /> 
   <br />
  ...
  <form  data-toggle="validator" role="form" id="investigate_frm" name="investigate_frm" method="post" action="<?php echo SURL?>complaints/add-complaint-process" autocomplete="off">
                      
  <div class="row">
    <div class="col-md-12" style="padding-left:0px;"> <br />
      <div class="form-group has-feedback">
        <label for="friend_email_address" class="col-md-2"><strong>Investigate<span class="required">*</span></strong></label>
         <div class="col-md-10">
        <textarea class="form-control" rows="5" id="investigate" name="investigate" placeholder="Type Investigation"></textarea>
        </div>
...
<script type="text/javascript">
 $(document).ready(function() {
    $('#investigate_frm').formValidation({
        framework: 'bootstrap',
        icon: {
