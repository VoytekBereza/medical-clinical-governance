...
<div style="display: none" class="row col-md-12">
    <div id="fancy-content-div">
    	...
    	<form id="push_invitation_form" action="#" method="POST" >
            ...
            <div class="col-md-12 alert alert-info" style="font-size:15px;">
		...
		<div class="well">
			<div class="row">
				...
				<div class="col-sm-12 col-md-12 col-lg-12">
					<h4 class="text-warning"> Note! It looks like you work in multiple pharmacies/ surgeries. Please choose pharmacy/ clinic you want to work with from the dropdown above. </h4>
...
<?php	}
		...
		<?php if($show_governance == 1){ ?>
			...
			<!--<div class="row"><div class="col-sm-12 col-md-12 col-lg-12"><p><h3>< ?php echo ucwords(filter_string($organization_details_arr['company_name']));?></h3><hr /></p></div></div>-->
			<div class="row">
				<div class="col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="row">
                              <div class="col-sm-12 col-md-12 col-lg-12" >
                                <h4 class="text-default" style="margin:0" > 
                                    <?php echo (filter_string($pharmacy_surgery['pharmacy_surgery_name']) != '') ? ucwords(filter_string($pharmacy_surgery['pharmacy_surgery_name'])) : '' ?>, <?php echo ($pharmacy_surgery['postcode'] != '') ? $pharmacy_surgery['postcode'] : '' ?>
                                ...
                                ?>
                                                ...
                                                <div class="row hidden" id="pending_invitation_container_m_<?php echo $pharmacy_surgery['id']; ?>">
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        ...
                                                        <div class="col-sm-8 col-md-8 col-lg-8 pull-left"><label class="text-danger" id="pending_inv_txt" >Invitation has been sent to <span id="invitation_sent_to_span_<?php echo $pharmacy_surgery['id']; ?>"><?php echo ($pharmacy_surgery['manager_invitations'][0]['user_email_address'] != '') ? $pharmacy_surgery['manager_invitations'][0]['user_email_address'] : '' ?></span> waiting acceptance.</label></div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12 col-lg-12" >
                                            ...
                                            <div class="row hidden" id="replace_invite_div_<?php echo $pharmacy_surgery['id']; ?>" >
                                             ...
                                             <?php 
												if(empty($pharmacy_surgery['manager_invitations'][0])){ $invitation_response_m_class = ''; } else { $invitation_response_m_class = 'hidden'; } ?>
                                                    <div class="row">
                                            ...
                                            <div class="btn-group" role="group" aria-label="...">
                                                <?php 
                                                    if(!$pharmacy_surgery['manager_is_owner']){
                                                		...
                                                		if($pharmacy_surgery['governance_read_status'] == 1) { 
												?>
                                                    ...
                                                    <?php
														...
														<?php	
                                                            if($pharmacy_surgery['purchased_items_split_arr']['pgds']['package_purchased'] == 1 && $pharmacy_surgery['purchased_items_split_arr']['pgds']['package_expired'] == 0){
                                                                 ...
                                                                 <li>
                                                                    <a href="<?php echo SURL?>organization/single-product-checkout/OP/1/<?php echo $pharmacy_surgery['manager_id'] ?>/<?php echo $pharmacy_surgery['id'] ?>" class="btn btn-xxs btn-danger">Standard Oral PGD Package <span class="glyphicon glyphicon-shopping-cart"></span></a>
                                                                </li>
                                                    <?php
                                            ...
                                            <!-- Premium Oral PGD Package-->
														<?php	
                                                            if($pharmacy_surgery['premium_purchased_items_split_arr']['pgds']['premium_package_purchased'] == 1 && $pharmacy_surgery['purchased_items_split_arr']['pgds']['premium_package_expired'] == 0){
																...
																if(count($premium_oral_pgd_arr) > 0){ 
																	...
																	for($i=0;$i<count($premium_oral_pgd_arr);$i++){
																		...
																		if($is_quiz_passed && $doctor_approval && $pharmacist_approval){ // If Purchased and not expired and assesment test is passed, doc and pharmacist have approved the PGD assesment
																			...
																			?>
																			 <li>
																			 <a href="javascript:;" class="btn btn-xxs btn-success"><?php echo filter_string($premium_oral_pgd_arr[$i]['pgd_name'])?></a>
																			</li>
																			<?php
                                                                 ...
                                                                 <li>
                                                                    <a href="<?php echo SURL?>organization/single-product-checkout/POP/1/<?php echo $pharmacy_surgery['manager_id'] ?>/<?php echo $pharmacy_surgery['id'] ?>" class="btn btn-xxs btn-danger">Premium Oral PGD Package <span class="glyphicon glyphicon-shopping-cart"></span></a>
                                                                </li>
                                                    <?php
                                                    
                                                } // End - if($pharmacy_surgery['purchased_items_split_arr']['pgds']['premium_package_purchased'] == 1 && $pharmacy_surgery['purchased_items_split_arr']['pgds']['premium_package_expired'] == 0)
                                            ?>
                                                            ...
                                                            <?php foreach($pharmacy_surgery['pharmacy_surgery_staff'] as $member): ?>                                                          
															   ...
															   <?php 
															   	...
															   	if($member['purchased_items_split_arr']['pgds']['package_purchased'] == 1 && $member['purchased_items_split_arr']['pgds']['package_expired'] == 0){
                                                                        ...
                                                                        ?>
                                                                        <li>
                                                                        <a href="<?php echo SURL?>organization/single-product-checkout/OP/1/<?php echo filter_string($member['staff_member_id']) ?>/<?php echo $pharmacy_surgery['id'] ?>" class="btn btn-xxs btn-danger">Standard Oral PGD Package <span class="glyphicon glyphicon-shopping-cart"></span></a>
                                                                        </li>
                                                                        <?php
                                                                        ...
                                                                        if(count($premium_oral_pgd_arr) > 0){
                                                                            ...
                                                                            for($i=0;$i<count($premium_oral_pgd_arr);$i++){
                                                                                ...
                                                                                if($is_quiz_passed && $doctor_approval && $pharmacist_approval){ // If Purchased and not expired and assesment test is passed, doc and pharmacist have approved the PGD assesment
                                                                                    ...
                                                                                    ?>
                                                                                     <li>
                                                                                      <a href="javascript:;" class="btn btn-xxs btn-success"><?php echo filter_string($premium_oral_pgd_arr[$i]['pgd_name'])?></span></a>
                                                                                    </li>
                                                                                    ...
                                                                                    ?>
                                                                                    <li>
                                                                                      <a href="javascript:;" class="btn btn-xxs btn-warning"><?php echo filter_string($premium_oral_pgd_arr[$i]['pgd_name'])?></span></a>
                                                                                    </li>
                                                               ...
                                                               ?>
                                                                        <li>
                                                                        	<a href="<?php echo SURL?>organization/single-product-checkout/POP/1/<?php echo filter_string($member['staff_member_id']) ?>/<?php echo $pharmacy_surgery['id'] ?>" class="btn btn-xxs btn-danger">Premium Oral PGD Package <span class="glyphicon glyphicon-shopping-cart"></span></a>
                                                                        </li>
                                                                <?php
                                                                        
                                                                    } // End - if($member['purchased_items_split_arr']['pgds']['premium_package_purchased'] == 1 && $member['premium_purchased_items_split_arr']['pgds']['package_expired'] == 0)
                                                                ?>
                                                        ...
                                                        ?>
                                                            ...
                                                            ?>
                                                                    ...
                                                                    <span id="staff_pending_invitation_span_<?php echo $pending_invitation['id']; ?>" class="pull-left" style="margin-top:10px">
                                                                       ...
                                                                       <label class="text-danger "> <?php echo ($pending_invitation['request_changes'] == '1') ? 'A request for contract change has been received by ' : 'Awaiting Contract Agreement'?> - <?php echo filter_string($pending_invitation['user_email_address'])?></label>
                                    ...
                                    <hr />
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2" style="padding:0">
                                                <button type="button" class="btn btn-warning btn-block elect-self-view-contract" data-target="< ?php echo $this->session->is_owner?>" rel="< ?php echo $pharmacy_surgery['type']; ?>" name="ST" value="< ?php echo $pharmacy_surgery['id']; ?>" > Elect Self </button>
