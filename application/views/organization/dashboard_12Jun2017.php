...
?>
        ...
        <div class="row"><div class="col-md-12"><p><label class="text-success">Elect Superintendent: No Superintendent</label></p></div></div><!-- ./ row-->
        <div class="row">
            <form name="elect_si_self_frm" id="elect_si_self_frm" method="post" action="<?php echo SURL?>organization/superintendent-elect-self">
...
<div class="row">
	...
	<?php 
        if($filter == 'All') { $filter_for = 'Pharmacies / Surgeries'; } else if($filter == 'P'){ $filter_for = 'Pharmacies'; } else if($filter == 'S')
    ...
    <?php 
        } //end if($filter!='All' && $filter!='Pharmacies / Surgeries' && $filter!='P' && $filter!='S')
    ?>
    </div>
            ...
            ?>
                    ...
                    <div class="row" id="add_staff_<?php echo $pharmacy_surgery['id']; ?>" style=" <?php echo ($count_no_of_staff > 5) ? 'display: none;' : ''?>" >
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p class="alert alert-info"><i class="fa fa-info-circle"></i> In this section, you can invite other staff members to work within your locations team. Just select the job type of the staff member and send them an invite email.</p>
...
<div class="row">
    ...
    <div class="col-md-2 col-lg-2"> 
    	<a href="<?php echo base_url(); ?>organization/edit-pharmacy-surgery" class="btn btn-sm btn-primary pull-right fancybox_view fancybox.ajax "><i class="fa fa-plus"></i> Add Location </a> 
     </div>
