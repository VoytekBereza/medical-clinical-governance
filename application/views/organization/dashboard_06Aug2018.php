...
<div class="row">
    ...
    <div class="col-sm-6 col-md-6 col-lg-6" style="margin-top: 5px;" >
        <div class="col-sm-4 col-md-4 col-lg-4">
          <form action="<?php echo base_url(); ?>organization/dashboard" method="get" id="list_pharmacies_surgeries_form">
        ...
        <div class="col-sm-8 col-md-8 col-lg-8">
          <form action="<?php echo base_url(); ?>organization/dashboard" method="get" id="search_pharmacy_surgery_form" class="form_validate">
            <div class="input-group">
