...
}//end array_sort_by_column(&$arr, $col, $dir = SORT_ASC) 
...
function get_pharmacy_surgery_medicines($category_id='', $medicine_id='', $pharmacy_surgery_id=''){
	...
	function is_any_oral_pgd_package_expired($oral_pgd_arr, $purchased_items_split_arr){
	...
	}//end is_package_expired($package_arr)
	
	function is_any_oral_pgd_package_expiring($oral_pgd_arr, $purchased_items_split_arr){

		$any_oral_pgd_expring = 0;
		...
		return $any_oral_pgd_expring;
		
	}//end is_any_oral_pgd_package_expiring($package_arr)
	
	function is_any_prem_pgd_package_expired($premium_oral_pgd_arr, $purchased_items_split_arr){
