...
class Organization_mod extends CI_Model {
	...
	public function update_organization_bank_settings($organization_id,$data){
		...
		$upd_data = array(
			...
			'responsible_person' => $this->db->escape_str(trim($responsible_person)),
			'account_holder_name' => $this->db->escape_str(trim($account_holder_name)),
			'bank_name' => $this->db->escape_str(trim($bank_name)),
			'account_no' => $this->db->escape_str(trim($account_no)),
			'sort_code' => $this->db->escape_str(trim($sort_code)),
			'swift_code' => $this->db->escape_str(trim($swift_code)),
			'iban_no' => $this->db->escape_str(trim($iban_no)),
			'modified_date' => $this->db->escape_str(trim($modified_date)),
			'modified_by_ip' => $this->db->escape_str(trim($modified_by_ip))
		);
	...
	}//end update_organization_bank_settings($data)
