...
class Pmr_mod extends CI_Model {
	...
	public function get_patient_history($patient_id,$order_status = '',$medicine_id = ''){
		...
		$this->db->select("patient_order_details.*, CONCAT('','',medicine_name) AS medicine_name,medicine_form.medicine_form,medicine_quantity.quantity AS online_quantity, medicine_strength.strength, CONCAT(kod_users.first_name,' ',kod_users.last_name) as prescribed_by_name");
	...
	public function get_patient_grouped_history($patient_id,$order_status = ''){
		...
		$this->db->dbprefix('patient_order_details');
		$this->db->distinct();
		$this->db->select("patients.first_name, patients.last_name, patient_order_details.*, CONCAT('','',medicine_name) AS medicine_name, medicine.id as medicine_id, medicine_form.medicine_form,medicine_quantity.quantity AS online_quantity, medicine_strength.strength, CONCAT(kod_users.first_name,' ',kod_users.last_name) as prescribed_by_name");
