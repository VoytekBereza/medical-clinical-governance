...
class Register_entry_mod extends CI_Model {
	...
	public function add_edit_register_entery($user_id, $pharmacy_surgery_id, $post){
		...
		if($register_entry_id ==""){
			...
			$ins_data = array(
				...
				'patient_id' => $this->db->escape_str(trim($patient_id)),
				'drug_id' => $this->db->escape_str(trim($drug_id)),
				'stock_received_suppied' => $this->db->escape_str(trim($stock_received_suppied)),
				'quantity_received' => $this->db->escape_str(trim($quantity_received)),
				'quantity_supplied' => $this->db->escape_str(trim($quantity_supplied)),
	...
	public function list_all_pom_private_entry($user_id,$pharmacy_surgery_id){
	...
	public function list_all_special($user_id,$pharmacy_surgery_id){
	...
	public function list_all_emergency_supply($user_id,$pharmacy_surgery_id){
	...
	public function list_cd_return($user_id,$pharmacy_surgery_id,$drug_id) {
